"""
Django settings for new_cms project.
...
SECRET_KEY = 'django-insecure-t7nngi&y@5v%nt!ahe8qhrzchn@kcika92$uk$ij$bfihi)t29'
...
ROOT_URLCONF = 'new_cms.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            os.path.join(BASE_DIR, "new_cms", "templates"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'new_cms.wsgi.application'
...
CMS_TEMPLATES = (
    ("index.html", _("Home")),
    ("about.html", _("About")),
    ("services.html", _("Services")),
    ("service-details.html", _("Services Post")),
    ("case-study.html", _("Portfolio")),
    ("case-study-details.html", _("Portfolio Post")),
    ("blog-two.html", _("Blog")),
    ("blog-details.html", _("Blog Post")),
